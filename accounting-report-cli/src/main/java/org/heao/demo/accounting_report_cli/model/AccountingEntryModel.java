package org.heao.demo.accounting_report_cli.model;
...
public class AccountingEntryModel {
    ...
    public static final class Builder {
        ...
        public static Builder anAccountingEntryModel() {
            return new Builder();
        }
        ...
        public AccountingEntryModel build() {
            AccountingEntryModel accountingEntryModel = new AccountingEntryModel();
